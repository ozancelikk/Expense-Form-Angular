...
const routes: Routes = [
  {path:"",pathMatch:"full",component:LoginComponent, data:{breadcrumb: "Oriana"},canActivate:[LoginGuard]},
    ...
    {path:"admin",component:AdminComponent, data:{breadcrumb: "Admin",},children:[
      ...
      {path:"vouncher/vouncher-details/:id",component:VouncherDetailComponent,data:{breadcrumb: lang.vouncherDetail},canActivate:[LoginGuard]}, 
      ...
      {path:"receipt/receipt-details/:id",component:ReceiptDetailComponent,data:{breadcrumb: lang.receiptDetail},canActivate:[LoginGuard]},
    ...
    {path:"employee",component:EmployeesComponent, data:{breadcrumb: "Employee",},children:[
      ...
      {path:"receipt-details/:id",component:ReceiptDetailComponent,data:{breadcrumb: lang.receiptDetail},canActivate:[EmployeeLoginGuard]},
      {path:"receipt-details/:id",component:ReceiptDetailComponent,data:{breadcrumb: lang.receiptDetail},canActivate:[EmployeeLoginGuard]},
