...
export default function getDocDefinition(
  ...
  return (function() {
    ...
    const headerRows = columnGroupsToExport ? 1 : 1; //2 : 1 yeni bir sayfada önceki sayfanın kopyasını oluşturuyor.
  ...
  function createTableCell(cellValue, colId) {
    ...
    const tableCell = {
      ...
      noWrap: PDF_PAGE_ORITENTATION === "portrait",
      style: "tableCell"
    };
